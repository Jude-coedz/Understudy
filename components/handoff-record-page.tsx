    ...
    <div className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-40 border-b border-border bg-background/95 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-5xl items-center justify-between px-5 lg:px-8">
          ...
          <div className="flex gap-2"><Link href="/workspace" className="rounded-lg border border-border bg-card px-3 py-2 text-xs font-medium text-muted">Open handoff</Link><Link href="/" className="rounded-lg border border-border bg-card px-3 py-2 text-xs font-medium text-muted">My handoffs</Link></div>
        </div>
      </header>
